...
pizzaIngredients.meats = ["Pepperoni","Sausage","Fennel Sausage","Spicy Sausage","Chicken","BBQ Chicken","Chorizo","Chicken Andouille","Salami","Tofu","Bacon",
    "Canadian Bacon",
    "Proscuitto",
    "Italian Sausage",
    "Ground Beef",
...
var resizePizzas = function(size) {
    ...
    function changePizzaSizes(size) {
        var newwidth;
        switch (size) {   //this function used to change size pizza 
            case "1":
                newwidth=25;
                break;
            case "2":
            ...
            case "3":
                ...
                break;
            default :
                console.log("has a bug")

        }
        var dwbara=document.querySelectorAll(".randomPizzaContainer");
        for (var i = 0; i < dwbara.length; i++) {
            dwbara[i].style.width=newwidth + "%";
        }
    }
...
function updatePositions() {
    ...
    for (var i = 0; i < items.length-150; i++) {   //update position of pizza ans each mover (-150) beacuse dont warning when scroll dwn
